...
tic
    ...
    f1 = ones(125*1, 1)*(1+209.5007/200);
    f2 = ones(125*1, 1)*(1+209.5007/100);
    f3 = ones(125*1, 1)*(1+209.5007/5);
    f4 = ones(125*1, 1)*(1+209.5007/50);
    f5 = ones(125*1, 1)*(1+209.5007/100);
    ff=zeros(125*15,1);
    f=[f1;f2;f3;f4;f5 ;ff];
    nNodes=125;
    ...
    line=linedata;
    power=powerdata;
    %Disconnect all loads other than CL
    ...
    %Adding Power limit constraints  
    insert=zeros(1,125);
    Ap1=[power(:,2)' insert insert insert insert];
    Ap2=[insert power(:,2)' insert insert insert];
    Ap3=[insert insert power(:,2)' insert insert];
    Ap4=[insert insert insert power(:,2)' insert];
    Ap5=[insert insert insert insert power(:,2)' ];
    Aineq=[Aineq; Ap1; Ap2; Ap3; Ap4; Ap5];     
    bineq1=zeros(124*5,1);
    bineq2=ones(125,1);
    bineq=[bineq1;bineq2];
    bineq=[bineq; 60; 80; 100; 70; 90]; 
    size(bineq);  
    ad=zeros(750, 125*15);
    Aineq=[Aineq ad];
    %% 
